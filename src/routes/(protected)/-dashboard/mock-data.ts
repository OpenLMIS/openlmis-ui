/* Demo-only mock data for the dashboard route. Safe to delete with the rest of the `-dashboard` folder when wiring up real APIs. */
...
export type ProjectRow = {
  ...
  team: { src: string; fallback: string }[];
  extra: number;
  dueDate: string;
};
...
export const SIGNUPS_DATA = [
  { week: 'Week 1', signups: 64 },
  { week: 'Week 2', signups: 78 },
  { week: 'Week 3', signups: 52 },
  { week: 'Week 4', signups: 92 },
  { week: 'Week 5', signups: 85 },
  { week: 'Week 6', signups: 110 },
  { week: 'Week 7', signups: 98 },
  { week: 'Week 8', signups: 125 },
];
