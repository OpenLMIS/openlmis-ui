    ...
    >
      ...
      >
        <div
          ...
          className={cn(
            'flex size-full flex-col bg-sidebar group-data-[variant=floating]:rounded-none group-data-[variant=floating]:shadow-sm group-data-[variant=floating]:ring-1 group-data-[variant=floating]:ring-sidebar-border',
...
function SidebarInset({
  ...
  surface = 'background',
  ...props
}: React.ComponentProps<'main'> & { surface?: 'background' | 'muted' }) {
  return (
    <main
      ...
      className={cn(
        ...
        surface === 'muted' && 'bg-muted dark:bg-background',
        className,
      )}
      {...props}
    />
...
function SidebarHeader({
  ...
  return (
    <div
      ...
      data-sidebar="header"
      className={cn('flex flex-col gap-2 p-2', bordered && 'border-b', className)}
      {...props}
    />
  );
}
